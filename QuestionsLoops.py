...
E5 = Solution("You could use any term to refer to the items in the list, as long as you keep them consistent, and preferably, easy to understand. I chose 'donut'.\n\nMonutsDonuts = ['Classic Chocolate','Strawberry','Maple-Bacon','Plain Glazed', 'Raspberry','Lemon Glaze']\n\nfor donut  in  MonutsDonuts:\n    if 'Glaze' in donut:\n        print(donut)")